...
#ifndef PATROL_SWIFT_H
#define PATROL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="patrol",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// That’s because the main thread is used by methods in <code>Automator</code>, which perform
...
SWIFT_CLASS("_TtC6patrol23ObjCRunDartTestResponse")
...
- (nonnull instancetype)initWithPassed:(BOOL)passed details:(NSString * _Nullable)details OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC6patrol12PatrolServer")
